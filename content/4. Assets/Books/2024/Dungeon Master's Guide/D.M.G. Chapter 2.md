...
**_Help Players Keep Up._** If a player isn’t sure what to do on their turn in combat, help the player decide by offering a quick recap of the state of the battle. How many foes are still standing, and how hurt do they look? What’s the most immediate threat to that character?
...
The [exploration rules](https://www.dndbeyond.com/sources/dnd/phb-2024/playing-the-game#Exploration) in the [Player’s Handbook](https://www.dndbeyond.com/sources/dnd/phb-2024) give guidelines for determining travel time based on the characters’ pace. In most cases, it’s fine to estimate that time rather than calculating it down to the minute. Exceptions include situations like these:
...
**Resting.** The trackers resume tracking after finishing a [Short](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#ShortRest) or [Long Rest](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#LongRest).
...
It’s important that players can tell when their characters’ opponents are casting spells, giving the characters the opportunity to cast [Counterspell](https://www.dndbeyond.com/spells/2619072-counterspell) or otherwise interfere with the spellcasting.
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#AdjustingDifficulty)
...
### Fight or Flight
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#FightorFlight)
...
- The monster starts its turn [Bloodied](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Bloodied) and more than half its allies are dead or have the [Incapacitated](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition) condition, while no one is dead or Incapacitated on the other side.
- The monster starts its turn Bloodied and has the [Frightened](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#FrightenedCondition) condition.
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#AvoidingorEndingaFight)

A creature that wishes to end or avoid a fight has two options:

**Flight.** The creature can retreat or run away on its turn. Select a destination for the fleeing party, such as a known place of safety (perhaps a room with a door that can be closed and barred). If the opponents pursue, you can use the “[Chases](https://www.dndbeyond.com/sources/dnd/dmg-2024/dms-toolbox#Chases)” section in [chapter 3](https://www.dndbeyond.com/sources/dnd/dmg-2024/dms-toolbox) to help adjudicate what happens.
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#CharacterAdvancement)
...
As a starting point, use the rules for [building combat encounters](https://www.dndbeyond.com/sources/dnd/dmg-2024/creating-adventures#CombatEncounters) in [chapter 4](https://www.dndbeyond.com/sources/dnd/dmg-2024/creating-adventures) to gauge the difficulty of the challenge. Then award the characters XP as if it had been a combat encounter of the same difficulty.

#### Milestones
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#Milestones)
...
**_Other Milestone Rewards._** If you want to reward your players for their progress through an adventure with something more than XP and treasure, also give them small rewards at milestone points, such as the following:
...
### Leveling Up
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#LevelingUp)
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#VariantTrainingtoGainLevels)
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#TrainingtoGainLevels)
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#LevelAdvancementwithoutXP)
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#SessionBasedAdvancement)
...
[LINK](https://www.dndbeyond.com/sources/dnd/dmg-2024/running-the-game#StoryBasedAdvancement)
